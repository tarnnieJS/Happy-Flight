...
class TicketReturnAdapter(
    private val bookings: List<BookingDataModel>,
    private val itemClickListener: OnItemClickListener
) : RecyclerView.Adapter<TicketReturnAdapter.BookingViewHolder>() {

    val selectedItems = mutableSetOf<Int>()

    interface OnItemClickListener {
        fun onBookingReturnSelected(item: BookingDataModel)
    }
    ...
    inner class BookingViewHolder(private val binding: ItemSelectTicketBinding) :
        ...
        init {
            binding.root.setOnClickListener {
                booking?.let {
                    ...
                    itemClickListener.onBookingReturnSelected(it)
